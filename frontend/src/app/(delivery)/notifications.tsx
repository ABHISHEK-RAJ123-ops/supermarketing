...
const styles = StyleSheet.create({
  ...
  notificationCard: { flexDirection: 'row', backgroundColor: COLORS.surface, padding: SIZES.medium, borderRadius: SIZES.radius, marginBottom: SIZES.medium, alignItems: 'center', ...SHADOWS.light },
